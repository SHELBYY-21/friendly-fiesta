...
const audit = transitionReconciliation({ entityId: 'd1', from: 'MATCHED', to: 'READY', actorId: 'reviewer', occurredAt: new Date('2026-09-12T00:00:00.000Z') });
assert(audit.occurredAt === '2026-09-12T00:00:00.000Z', 'audit event is deterministic');
